...
- [Codex App 边玩边赚钱实战教学：那些不为人知的使用秘诀](articles/2053724702993190917-Codex进阶实战教程，办公四件套、3D视频、电商自动化.md)（图片 27）
- [GPT2-image变现杠杆思路，6步赚钱路线图](articles/2052569175755829477-GPT2-image变现杠杆思路，6步赚钱路线图.md)（图片 4）
- [第一款App已有上百付费用户，全程用Codex完成](articles/2061652037298004332-第一款App已有上百付费用户，全程用Codex完成.md)（图片 1）
- [GUI可视化数据中台想法，打通微信飞书X数据](articles/2054928950783299838-GUI可视化数据中台想法，打通微信飞书X数据.md)（图片 0）
- [Codex App 从0到1完整入门教程：把这个超级APP的每一个细节抽丝剥茧讲清楚](articles/2051891231953920174-Codex-App-小白完整入门指南，界面设置权限全解析.md)（图片 24）
- [Codex新对话代理问题完整修复方案](articles/2053082764463968671-Codex新对话代理问题完整修复方案.md)（图片 0）
- [Codex App是普通人最佳本地AI选择，对比Claude Code](articles/2049096540807893351-Codex-App是普通人最佳本地AI选择，对比Claude-Code.md)（图片 0）
- [基于EverOS重构Codex记忆系统并开源模板](articles/2067985719675773192-基于EverOS重构Codex记忆系统并开源模板.md)（图片 3）
- [Codex+Obsidian+SQLite+向量检索迭代升级](articles/2068555151733043504-Codex+Obsidian+SQLite+向量检索迭代升级.md)（图片 3）
- [一键搭建Obsidian长期记忆系统完整提示词](articles/2067985724809642159-一键搭建Obsidian长期记忆系统完整提示词.md)（图片 0）
- [外接Obsidian大脑优化版提示词，Token大幅节省](articles/2061756699170807819-外接Obsidian大脑优化版提示词，Token大幅节省.md)（图片 0）
- [Codex记忆系统开源模板，支持多Agent共用](articles/2068217064729592095-Codex记忆系统开源模板，支持多Agent共用.md)（图片 2）
- [从0到1开发并部署生产级Agent实战视频教程](articles/2069345006859805168-从0到1开发并部署生产级Agent实战视频教程.md)（图片 0）
- [非技术小白用Codex完整开发项目的最佳路径](articles/2049437572959744222-非技术小白用Codex完整开发项目的最佳路径.md)（图片 0）
- [Codex打通微信飞书自动归档合同交付物](articles/2069052715221782979-Codex打通微信飞书自动归档合同交付物.md)（图片 2）
- [Computer Use打通Codex与ChatGPT Pro调用最强模型](articles/2068608638626017702-Computer-Use打通Codex与ChatGPT-Pro调用最强模型.md)（图片 1）
- [Codex最好用插件推荐，Computer Use与Playwright优先](articles/2065019075760382327-Codex最好用插件推荐，Computer-Use与Playwright优先.md)（图片 2）
- [Codex官方支持开源模型DeepSeek GLM Kimi](articles/2067233776540016887-Codex官方支持开源模型DeepSeek-GLM-Kimi.md)（图片 0）
- [Codex+GPT5.5实现微信双开Skill](articles/2049047427383210334-Codex+GPT5.5实现微信双开Skill.md)（图片 5）
- [Computer Use冰山一角用法大清单，10+真实案例](articles/2061824810267906059-Computer-Use冰山一角用法大清单，10+真实案例.md)（图片 3）
- [用Codex完成App备案与华为审核全流程](articles/2065418851240620505-用Codex完成App备案与华为审核全流程.md)（图片 2）
- [Codex修复自家WiFi连接问题仅用2分钟](articles/2067543658283548796-Codex修复自家WiFi连接问题仅用2分钟.md)（图片 2）
- [Claude Fable5 vs Codex，坚持使用Codex理由](articles/2064503056474222925-Claude-Fable5-vs-Codex，坚持使用Codex理由.md)（图片 0）
- [Codex /Sites命令构建团队网站或App](articles/2061992858585075972-Codex--Sites命令构建团队网站或App.md)（图片 2）
- [Claude vs GPT Codex全面对比分析](articles/2060965779605213483-Claude-vs-GPT-Codex全面对比分析.md)（图片 0）
- [学习Codex最简单方法，搜索主页所有Codex推文](articles/2063147147223355740-学习Codex最简单方法，搜索主页所有Codex推文.md)（图片 1）
- [重庆线下Codex分享，下沉市场仍有巨大空间](articles/2061074796369358916-重庆线下Codex分享，下沉市场仍有巨大空间.md)（图片 1）
...
![图片 1](images/1782646031650_media_HIAlj-KaIAAvGu2.jpg)
...
![图片 3](images/1782646136969_media_HIAmjXXbcAAjgqS.jpg)
...
![图片 4](images/1782646129762_media_HIAmgWaaYAALLRx.jpg)
...
![图片 5](images/1782646125963_media_HIAmdVtbUAAdvp5.jpg)
...
![图片 6](images/1782646117680_media_HIAmaWIacAAI8JG.jpg)
![图片 7](images/1782646108752_media_HIAmXW1bIAAIr4D.jpg)
...
![图片 8](images/1782646107522_media_HIAmUTlaYAAaEpT.jpg)
![图片 9](images/1782646100947_media_HIAmRSGbAAAxjM3.jpg)
![图片 10](images/1782646089029_media_HIAmOONaQAA3uS7.jpg)
![图片 11](images/1782646083155_media_HIAmLRabwAAxDTZ.jpg)

当然，在我没有给出skill或者优化后的提示词的情况下，能做出这样的效果，已经非常优秀了！

![图片 12](images/1782646077655_media_HIAmIPoaMAA7lCp.jpg)

众所周知，现在X最火的PPT制作方法，绝对是打破传统的HTML绘制PPT，现在相关爆火的Skill也是数不胜数，其次直接生成图片PPT也是一个另辟蹊径的办法。

![图片 13](images/1782646073022_media_HIAmFQha8AAOWt1.jpg)

下面我将用“进阶版”PPT的操作路径给大家带来一些启发：
路线一：图片型 PPT

![图片 14](images/1782646143641_media_HIBFTaEacAAM8v8.jpg)

图片型 PPT 的意思是：先让 Codex 生成一张张 16:9 的视觉图片，再把这些图片铺到 PPT 里。

![图片 15](images/1782646068823_media_HIAmCMOaYAAQIxT.jpg)

每一页 PPT 本质上就是一张完整图片。

![图片 16](images/1782646024394_media_HIAl_Mta0AAVcuv.jpg)

效果还是蛮不错的，因为底层是GPT2-imge。

![图片 17](images/1782646019187_media_HIAl8MvaEAAmSLO.jpg)

当然，这种方式生成的PPT并非无法编辑，还是有很多方法滴，如果感兴趣，可以私信找我要文档～
路线二：HTML 型 PPT

![图片 18](images/1782646016086_media_HIAl5MyaIAADs7e.jpg)
...
![图片 19](images/1782646005289_media_HIAl2LgbwAAg9ue.jpg)
...
![图片 20](images/1782646054383_media_HIAlzL9bgAA3d5p.jpg)
...
![图片 21](images/1782646051882_media_HIAlwMhasAAAqo9.png)
...
![图片 22](images/1782646049591_media_HIAltNFbEAAPS6V.jpg)
...
![图片 23](images/1782646039907_media_HIAlqNQbUAA5QC2.png)
![图片 24](images/1782645863566_emoji_v2_svg_1f984.svg.svg)
![图片 25](images/1782645854044_emoji_v2_svg_1f440.svg.svg)
...
![图片 26](images/1782645861743_emoji_v2_svg_1f497.svg.svg)
...
![图片 27](images/1782645877363_emoji_v2_svg_2728.svg.svg)
...
![图片 1](images/1782646993367_media_HHsOFPNbQAAONK3.jpg)
...
![图片 2](images/1782647002203_media_HHsOHI6a0AAJD-b.jpg)
![图片 3](images/1782647012967_media_HHsOKDqaEAAa8xz.jpg)
...
![图片 4](images/1782647026157_media_HHsONhWbMAEjSTm.jpg)
...
![图片 1](images/1782647060530_media_HJx0yCGa0AAbY9r.jpg)
...
![图片 1](images/1782645996771_media_HHnH5-xaIAAfPDj.jpg)
...
![图片 3](images/1782645954968_media_HHmxoi_aQAEclcw.jpg)
...
![图片 4](images/1782645970691_media_HHmyBuxbUAABj7h.jpg)

先看一张打开后的整体界面。

![图片 5](images/1782645953649_media_HHmx6cRbEAEdFDk.jpg)

这张图先不用看细节。你只要记住：左边是导航栏，中间是你和 Codex 对话的地方，右边有时会出现结果、来源、预览和代码变化。

![图片 6](images/1782645940789_media_HHmwSdOaQAAlP2t.png)

这就是 Codex App 和普通聊天框最大的差别：它不是只有“问答”，它还有“工作现场”。
二、下载和登录

![图片 7](images/1782645977091_media_HHmyxjWboAAHaaP.jpg)
...
![图片 8](images/1782645935412_media_HHmwOqGaUAA_S7y.jpg)
...
![图片 9](images/1782645964537_media_HHmy7s3akAAZgFO.jpg)
...
![图片 10](images/1782645931285_media_HHmwJzpaYAAU3Gp.jpg)

五、左侧导航栏：你从这里进入不同工作流

![图片 11](images/1782645985074_media_HHmzNoabcAA8qzd.jpg)
...
![图片 12](images/1782645922314_media_HHmwGrmaMAA9LPK.jpg)
...
![图片 13](images/1782645992808_media_HHmzTE3bMAAg-F8.jpg)
...
![图片 14](images/1782645917683_media_HHmwDkgaUAA8Gjm.jpg)

点左侧“自动化”，会看到自动化页面。

![图片 15](images/1782645912358_media_HHmwAvsaQAAcKvy.jpg)
...
![图片 16](images/1782645897461_media_HHmv9IebQAAD9pr.jpg)
...
![图片 17](images/1782645892030_media_HHmv6UTa0AAJGhH.jpg)

图片预览。

![图片 18](images/1782645887742_media_HHmv3ixasAAxGiI.jpg)

PDF / 文档预览。

![图片 19](images/1782645874827_media_HHmv0vaakAAf2oq.jpg)
...
![图片 20](images/1782645907880_media_HHmvw_iacAAfIMi.jpg)
...
![图片 21](images/1782645863566_emoji_v2_svg_1f984.svg.svg)
...
![图片 22](images/1782645854044_emoji_v2_svg_1f440.svg.svg)

这个页面基本不影响 Codex 能不能完成任务，它只影响你看界面UI的时候舒不舒服。

![图片 23](images/1782645861743_emoji_v2_svg_1f497.svg.svg)

但是有个新功能大家也许会感兴趣：可以在这个界面选择一只桌宠，然后再Codex对话框输入/宠物就能唤起一只陪伴大家工作的小可爱！

![图片 24](images/1782645877363_emoji_v2_svg_2728.svg.svg)
...
![图片 1](images/1782647124992_media_HLL153dbwAAfz1z.png)
...
![图片 2](images/1782647129683_media_HLL16k5acAAljr3.jpg)
![图片 3](images/1782647078559_media_HKIqB2hbsAAEiQr.jpg)
...
![图片 1](images/1782647132148_media_HLT7EK8aYAA3GMJ.png)

EmbeddingGemma 是一个 text embedding model，也就是文本向量模型。它的作用是把一段文字转换成一组数字向量，也就把 Markdown 本地记忆文档翻译成“语义坐标”。

![图片 2](images/1782647124992_media_HLL153dbwAAfz1z.png)
...
![图片 3](images/1782647129683_media_HLL16k5acAAljr3.jpg)
...
![图片 1](images/1782647143947_media_HLa_qSKbMAAS2t8.jpg)
...
![图片 2](images/1782647151262_media_HLbAUb6agAAVzKM.jpg)
...
# Computer Use打通Codex与ChatGPT Pro调用最强模型
...
# Codex最好用插件推荐，Computer Use与Playwright优先
...
# Codex官方支持开源模型DeepSeek GLM Kimi
...
![图片 1](images/1782647033318_media_HJ0R8mjaQAEH_fI.jpg)
...
![图片 2](images/1782647035657_media_HJ0SCsqbgAArvgO.jpg)
...
![图片 3](images/1782647060530_media_HJx0yCGa0AAbY9r.jpg)
...
![图片 1](images/1782647100867_media_HKm7qHJb0AA4eoy.jpg)
...
![图片 2](images/1782647060530_media_HJx0yCGa0AAbY9r.jpg)
...
![图片 1](images/1782647113261_media_HLFjompbwAECZbg.png)

今天下午刚回家，好一段时间没连，试了半天，都是报错，给我急坏了。结果我让Codex检查下，2分钟就修好了，真的是科技改变生活啊。

![图片 2](images/1782647098498_media_HLFj8Oda8AATz2T.jpg)
...
![图片 1](images/1782647045463_media_HJ2qOSka8AEK2_3.jpg)
...
![图片 2](images/1782647047361_media_HJ2rDk7aAAApT3H.jpg)
...
![图片 1](images/1782647054701_media_HJpmyCfbsAAq46t.jpg)
