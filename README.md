...
这个仓库把 Codex 国内站入口、桌面 App 下载、完整入门教程、27 章 Codex 实战图文教程、实战案例库和速查资料放在一起。适合先解决访问、账号、付款和配置，再用教程完成第一个可交付项目。
...
| 登录入口 | [api.yoyochatai.com](https://api.yoyochatai.com) |
| 购买入口 | [9.plus/shop/yoyoapi](https://9.plus/shop/yoyoapi) |
...
4. 想看真实图文实操，阅读 [27 章 Codex 实战图文教程](tutorials/yichen-codex-articles/README.md)。
...
| 配置复杂 | 新手分不清官方订阅、中转 API、客户端、yoyo-plugin |
...
| yoyo-plugin + 中转 API | 第三方中转 | 不需要 | 不需要海外手机号 | 想自己配置客户端的人 |
